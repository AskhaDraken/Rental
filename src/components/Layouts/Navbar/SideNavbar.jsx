        ...
        <div className='fixed '>
            <div className='flex flex-row items-start text-black'>
                <div className='flex w-fit h-screen'>
                    <div className={`${isToggle ? "w-64" : "w-fit"} h-full flex justify-center p-4 transition-all duration-500 relative bg-fourth`}>
                        ...
                        <div className={`absolute transition-transform  duration-300 translate-y-1 bg-fourth border-4 border-white flex justify-center items-center -right-5 w-10 h-10 rounded-full cursor-pointer`}
