...
const CardTelevision = ({ item, onClick }) => {
  ...
  return (
    <div className='flex flex-col min-w-36 gap-2 items-center justify-center cursor-pointer p-4 bg-secondary text-white rounded-md hover:shadow hover:scale-[102%] transition-all' onClick={onClick}>
